...
export const products = [
  ...
  { id: 'membership_vip', kind: 'membership-vip', title: 'Membresía VIP · 2 accesos', seller: 'PROJECT GALAXY', category: 'Memberships', price: 1500, rating: null, reviews: null, tone: 'membership', mark: 'VIP', image: vipMembershipImage, description: 'Membresía anual para dos personas con acceso para ambos. Pago manual en USDT y confirmación por el administrador.' },
  ...
  { id: 'prd_signal', title: 'Kill Zone Playbook', seller: 'Galaxy Trading Desk', category: 'Education', price: 29, rating: 4.8, reviews: 96, tone: 'blue', mark: 'KZ', description: 'Un marco educativo y explicado para acompañar las sesiones de London y New York con contexto de liquidez.' },
