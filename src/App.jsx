...
function MembershipMarketplaceCards({ product, onOpen }) {
  return <section className="membership-marketplace surface">
    <header><div><p className="eyebrow">PROJECT GALAXY XAUUSD MEMBERSHIP</p><h2>Activa tu acceso a las Kill Zones.</h2><p>Operativas en vivo de lunes a viernes, acompañamiento de XAUUSD, chat y pantalla compartida en una sola membresía.</p></div><span><ShieldCheck /> USDT · TRC20 / ERC20</span></header>
