...
function CollaborationOverlay({ active, mode, tool = 'pen', color, strokes, cursors, onPoint, onChange, onDelete, onSelectionChange, onFinish }) {
  const ref = useRef(null); const drawing = useRef(null); const dragging = useRef(null); const resizing = useRef(null); const lastSent = useRef(0); const [selectedId, setSelectedId] = useState(null);
